                ...
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-8">
                        <router-link to="/" class="text-primary font-semibold text-2xl no-underline">
                            <!-- <span class="text-primary font-semibold">Vue</span>Admin  -->
                        ...
                        <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">欢迎您！</div>
                        <span class="text-muted-color font-medium">登录以继续</span>
                    </div>

                    <div>
                        <label for="email1" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">电子邮件</label>
                        <InputText id="email1" type="text" placeholder="邮件地址" class="w-full md:w-[30rem] mb-8" v-model="email" />
